...
import com.example.safteynetlert.domaine.pipeline_builder.PipelineMiddleware.Next;
import com.example.safteynetlert.domaine.pipeline_builder.PipelineSupplier.Supply;
import com.example.safteynetlert.domaine.pipeline_builder.validators.ValidationFailedException;
...
public class PipelineBuilder
    ...
    @SuppressWarnings({"rawtypes",
                       "unchecked"})
    public <THandler extends PipelineHandler> PipelineBuilder handlers(
            Supply<THandler> requestHandlers) {
    ...
    public <TMiddleware extends PipelineMiddleware> PipelineBuilder middlewares(
